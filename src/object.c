...
// copyString() assumes it cannot take ownership of the characters
// you pass in. Instead, it conservatively creates a copy of the characters on the heap that the ObjString can own.
